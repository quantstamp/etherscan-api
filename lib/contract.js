...
module.exports = function(getRequest, apiKey) {
  return {
    ...
    getabi(address) {
      ...
      var query = querystring.stringify({ module, action, address, apiKey });

      return getRequest(query);
    },

    /**
     * Returns the Source Code of a given verified contract
     * @param {string} address - Contract address
     * @example
     * api.contract
     *  .getsourcecode('0xfb6916095ca1df60bb79ce92ce3ea74c37c5d359')
     *  .then(console.log)
     * @returns {Promise.<object>}
     */
